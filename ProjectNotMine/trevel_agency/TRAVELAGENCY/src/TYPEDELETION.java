 ...
 * @author xp_system
 */
public class TYPEDELETION extends javax.swing.JFrame {
   ...
   try {
            ...
            int no = Integer.parseInt( jTextField1.getText().trim());
  ...
  String vno =  jTextField1.getText();
                    ...
                    // Member table
                    String strSQL ="DELETE FROM VEH_type WHERE TYPE_no="+(no)+"";
