 ...
 * @author xp_system
 */
public class MembDel extends javax.swing.JFrame {
...
// Steps to confirm deletion
    ...
    String strSQL = "delete from member where memb_no="+Mno ;
            ...
            JOptionPane.showMessageDialog(this, e.getMessage()+""+"error in connection");
     e.printStackTrace();}
