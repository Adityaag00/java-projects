 ...
 * @author ARJUN
 */
public class ForMemShip extends javax.swing.JFrame {
...
if(then==JOptionPane.YES_OPTION){
     String ssql="INSERT INTO Member(memb_no, memb_name, memb_add, mdate, medate, mfee, mem_status, mem_issue, MEM_phone)values("+(no)+", '"+(name)+"', '"+(add1+add2)+"', '"+(date)+"', '"+(date)+"', "+(fee)+", "+(status)+", '"+(issue)+"', '"+(pno)+"');";
