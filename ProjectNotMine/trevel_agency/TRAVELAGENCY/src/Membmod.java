 ...
 * @author xp_system
 */
public class Membmod extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Member Modification Form");
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(txtMStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addContainerGap()))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    try {
            ...
            double MFee = Double.parseDouble(txtMFee.getText());
                 // Member table
                     String strSQL = "Update Member set memb_name ='"+(MName)+"', memb_add = '"+(MAdd)+"', mem_phone = '"+(MPh1)+"', mdate = '"+(MDate)+"', mfee = "+(MFee)+" where memb_no = " + (Mno);
