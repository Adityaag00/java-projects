 ...
 * @author manjeet
 */
public class shoes_men extends javax.swing.JFrame {
Connection con = null;
Statement stmt = null;
ResultSet rs= null;
int icode, p;
String bname, iname, t;
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1320, 620));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel33, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(64, 64, 64)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jScrollPane1.setBounds(40, 100, 1250, 467);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1067;");
        while(rs.next()){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1068;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1069;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1070;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1071;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1072;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1073;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1074;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1075;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1076;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1077;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1078;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton26ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1079;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1080;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton30ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1081;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
        // TODO add your handling code here:
        try{ 
        rs = stmt.executeQuery("select * from mens_wear where item_code= 1082;");
        while(rs.next()){
            icode = rs.getInt("item_code");
            p = rs.getInt("price");
            bname = rs.getString("brandname");
    ...
    private void jButton33ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton33ActionPerformed
        // TODO add your handling code here:
        billing_section a= new billing_section();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(shoes_men.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
